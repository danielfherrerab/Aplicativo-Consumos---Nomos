				...
				<div class="contenedor_tabla">
					<table border="1" class="acordeon">
						...
						<tbody>
							<?php
							$a = 0;
								$ordenes = mysqli_query($conexion,"SELECT distinct (numero_op) from consumo_planchas where (fecha_consumo between '$dia' and '$datetime_final') order by id_consumo desc");
